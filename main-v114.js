...
const fragmentShader = /* glsl */`
  ...
  // Keep the current v1.13 space/background untouched.
  ...
  void main() {
    ...
    // Current space/background preserved exactly from the latest renderer.
    ...
    // Everything below is the preferred older black-hole render.
...
autoButton.addEventListener('click', () => {
  ...
  statusBox.textContent = autoApproach
    ? 'Auto approach active. Preferred lensing geometry restored.'
...
resetButton.addEventListener('click', () => {
  ...
  syncControls();
  statusBox.textContent = 'Reference view restored. Old black-hole render, current universe.';
});
